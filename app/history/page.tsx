          ...
          <section id="gurukrpa" className="history-chapter">
            ...
            {lang === 'en' ? (
              <div>
                ...
                <p>During this time, he received the opportunity to serve at the feet of the Jagadguru of the Kanchi Kamakoti Peetham, Sri Sri Sri Chandrasekharendra Saraswati (Periyava), who was known as the "Walking God" and an embodiment of Adi Shankara. He was also blessed with the privilege of partaking in meals in the Sage's presence (Ananda-pankti-bhojana) and received the sage's remaining cloth (Sesha Vastra) and the Padukas worn by him as sacred Prasada. When the Swamy gently suggested that the late Sri Venkataramayya accept Sannyasa (renunciation), he replied softly that his fifth son was not yet married and therefore he could not renounce his worldly duties. In this manner, it is an indisputable fact that he made his life meaningful.</p>
                <p>It is noteworthy that although his four sons established permanent residences in Hyderabad, the late Sri Venkataramayya did not abandon his adherence to the traditional customs of Sanatana Dharma. Consequently, his fourth son took up the profession of a school teacher and remained in the small village of Parnapalle to serve his father and paternal aunts. Both he and his wife considered themselves blessed to have served them until the end, ensuring their traditional way of life remained undisturbed.</p>
                <p>In his final moments, he fell ill. Just as medical help was about to reach him, at the age of 78, in the presence of two of his sons and his beloved younger brother, while chanting the name of "Sri Rama," he offered himself to the lotus feet of Sri Ramachandra on the auspicious day of Pramadicha Nama Samvatsara, Kartika Shuddha Ekadashi, Monday, November 5, 1973.</p>
              ...
              <div>
                ...
                <p>ఆయన తన చివరి ఘడియలలో అస్వస్థతకు గురి అయ్యి, వైద్యుడి సహాయము అందునంతలోనే తన 78 సంవత్సరముల వయస్సులో ఇద్దరు కుమారులు మరియు తనకు ప్రియమైన తమ్ముడి సమక్షంలో "శ్రీరామ" నామము జపిస్తూ ప్రమాదీచ నామ సంవత్సర కార్తీక శుద్ధ ఏకాదశి సోమవారము పర్వదినమున అనగా 1973 నవంబరు 5 వ తారీకు శ్రీరామచంద్రుని పాదపద్మముల కు తనను తాను సమర్పణము చేసుకొన్నారు.</p>           
              </div>
            )}
          </section>
